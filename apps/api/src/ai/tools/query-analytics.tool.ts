      ...
      properties: {
        ...
        filters: {
          ...
          properties: {
            ...
            product_category: {
              type: 'array',
              description: 'General product family (use for names like "pencil"/"bút chì").',
              items: {
                type: 'string',
                enum: [
                  'BOOK',
            ...
            sku: {
              type: 'array',
              description: 'Specific SKU code such as "PENCIL-0076"; for general names use product_category.',
              items: { type: 'string' },
            },
